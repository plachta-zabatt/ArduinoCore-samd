...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  8, PIO_MULTI, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL),  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // S_SD (TX)
  ...
  // 21..33
  // Digital pins
  { PORTA,  4, PIO_MULTI, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL),  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_4, GCLK_CCL_NONE },        // RE 21
  ...
  { PORTB,  9, PIO_MULTI, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL), TC4_CH1, No_ADC_Channel, EXTERNAL_INT_9, GCLK_CCL_NONE },   // DE
