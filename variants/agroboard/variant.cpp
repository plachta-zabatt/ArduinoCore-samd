...
const PinDescription g_APinDescription[]=
{
  ...
  //1 - 10 SERCOM
  //SIM Serial1 SERCOM1
  { PORTA, 0, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // RX
  { PORTA, 1, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // TX
  //MODBUS Serial2 SERCOM2
  { PORTA, 9, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL, NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // RO (RX)
  { PORTA, 14, PIO_SERCOM, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL),  NOT_ON_TIMER, No_ADC_Channel,  No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // DI(TX)
  //LoRa SPI Serial3 SERCOM3
  { PORTA,  17, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL,  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // SS
  { PORTA,  18, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL,  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // MOSI
  { PORTA,  19, PIO_SERCOM, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER|PIN_ATTR_ANALOG),  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // SCK
  { PORTA,  22, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL,  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // MISO
  //SDI12- Serial Serial0 SERCOM0
  { PORTA,  8, PIO_SERCOM, PER_ATTR_DRIVE_STD, PIN_ATTR_DIGITAL,  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // S_SD (TX)
  { NOT_A_PORT,  0, PER_ATTR_DRIVE_STD, PIO_NOT_A_PIN, PIN_ATTR_DIGITAL,  NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // RX
  ...
  { PORTB,  3, PIO_MULTI, PER_ATTR_DRIVE_STD, (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG),  NOT_ON_TIMER, ADC_Channel11, EXTERNAL_INT_, GCLK_CCL_NONE },      // S_DS2 29
